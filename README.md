...
- [Git and GitHub](https://git.generalassemb.ly/ga-wdi-boston/git-github)

## Objectives

- Get some practice with branching in a git repository.
- Review git commands that we went over in class.
